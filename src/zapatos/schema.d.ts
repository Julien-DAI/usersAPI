...
declare module 'zapatos/schema' {
  ...
  export namespace matchs {
    ...
    export interface Insertable {
      ...
      * - Nullable, no default
      */
      round_number?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment;
      /**
      * **matchs.status**
      * - `bool` in database
      * - Nullable, no default
    ...
    export interface Updatable {
      ...
      * - Nullable, no default
      */
      round_number?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment>;
      /**
      * **matchs.status**
      * - `bool` in database
      * - Nullable, no default
